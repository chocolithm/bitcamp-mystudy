...
<c:if test="${not empty board}">
    <form action='/board/update' method="post" encType="multipart/form-data">
        ...
        작성일: <input readonly type='text' value='<fmt:formatDate value="${board.createdDate}" pattern="yyyy-MM-dd" />'><br>
            ...
            <ul>
                <c:forEach items="${board.attachedFiles}" var="attachedFile">
                    <li>
                        ...
                        <a href="/board/file/delete?fileNo=${attachedFile.fileNo}">삭제</a>
                    </li>
                </c:forEach>
            </ul>
        </c:if>
